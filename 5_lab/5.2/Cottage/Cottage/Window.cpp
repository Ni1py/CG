...
void Window::SetupTextures()
{
	...
	m_wallTexture = m_textureLoader.LoadTexture("Assets/wall.png");
	m_cottage.SetWallTexture(m_wallTexture);

	m_windowTexture = m_textureLoader.LoadTexture("Assets/window.png");
	...
	m_garageDoorTexture = m_textureLoader.LoadTexture("Assets/garage.png");
